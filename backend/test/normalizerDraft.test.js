...
import { normalizeCompositionStats, normalizeDraftStats } from '../dist/backend/src/data/normalizer.js';
...
test('normalizeDraftStats aggregates picks/bans and win rate for picks', () => {
  ...
  const stats = normalizeDraftStats(seriesStates, teamId);
...
test('normalizeCompositionStats groups per-series compositions and computes win rate', () => {
  ...
  const comps = normalizeCompositionStats(seriesStates, teamId);
